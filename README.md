...
- **Modular PowerShell.** Seven modules with manifests and explicit exports,
  `Set-StrictMode -Version Latest` throughout, 163 Pester tests, PSScriptAnalyzer clean,
...
Parse check, PSScriptAnalyzer, 163 Pester tests, and a sensitive data scan. Continuous
